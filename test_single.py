...
from experiments.testing_1_task_single import *
...
def main():
    ...
    baseline_result = test_1_task_single(task_index=task_to_test, args = args)
    with open(result_dir+'/'+'baseline_task_'+str(args.test_task_id)+'.pkl', 'wb') as pickle_file:
        pickle.dump(baseline_result, pickle_file)
